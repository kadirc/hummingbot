...
# B{TOKEN} only applies to BUSD
CAPITAL_B_SYMBOLS_PATTERN = re.compile(r"^B(USD)")
...
# {TOKEN}t generally means USDt
T_SYMBOLS_PATTERN = re.compile(r"(\w+)t$", re.IGNORECASE)


def unwrap_token_symbol(on_chain_token_symbol: str) -> str:
    patterns: List[Pattern] = [
        CAPITAL_W_SYMBOLS_PATTERN,
        CAPITAL_B_SYMBOLS_PATTERN,
